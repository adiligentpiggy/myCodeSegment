...
public class HttpClient4Demo2 {
    ...
    public static String server_url = "http://183.63.117.154:8010/v2/audio/upload_file.json";//"http://183.63.117.154:8010/v2/audio/upload_file.json";
...
public static void uploadFile(String fileName) {  
        try {  
            ...
            // 定义数据分隔线  
            String BOUNDARY = "WebKitFormBoundary8tGKRy3uK3WAgUTB";  
            // 服务器的域名  
            ...
            sb.append(newLine);  
            // 文件参数,photo参数名可以随意修改  
            sb.append("Content-Disposition: form-data;name=\"medium[virtual_file][]\";filename=\"" + fileName  
                    + "\"" + newLine);  
